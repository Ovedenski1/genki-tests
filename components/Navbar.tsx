...
export function Navbar() {
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200/70 bg-white/90 shadow-md shadow-slate-200/40 backdrop-blur-xl">
      <nav className="mx-auto flex min-h-20 max-w-7xl items-center justify-between gap-3 px-4 py-3 sm:min-h-24 sm:px-6">
        <Link href="/" className="flex min-w-0 items-center">
          <img
            src="/logo.png"
            alt="Pokotoba"
            className="h-12 w-auto object-contain sm:h-16 lg:h-13"
          />
        </Link>
        ...
        <div className="hidden items-center gap-8 md:flex lg:gap-14">
          <Link
            href="/about"
            className="text-lg text-black hover:text-[#173763] lg:text-xl"
          >
            About
          </Link>
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="relative flex h-14 shrink-0 items-center gap-2 overflow-hidden rounded-lg bg-gradient-to-br from-[#fff0b8] via-[#ffdc82] to-[#cdeaa6] px-3 text-sm text-black shadow-md shadow-yellow-200/60 transition hover:-translate-y-0.5 hover:brightness-105 sm:px-4 sm:text-base lg:px-5 lg:text-lg"
        >
          ...
          <img
            ...
            alt=""
            className="relative z-10 h-10 w-10 shrink-0 object-contain mix-blend-multiply sm:h-11 sm:w-11 lg:h-12 lg:w-12"
          />
